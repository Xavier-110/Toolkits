...
const dbPath=resolve(process.env.OPS_TOOLKIT_DB || 'data/ops-toolkit.sqlite');
const manager=await openManagedStorage(dbPath);
const service=createService({dbPath,manager,origin});
