...
const commands=[['--test','tests/*.test.mjs'],['build.mjs'],['tests/navigation-browser.mjs'],['tests/manual-online-browser.mjs'],['tests/version-management-browser.mjs'],['tests/environment-browser.mjs'],['tests/ui-boundaries.mjs']];
