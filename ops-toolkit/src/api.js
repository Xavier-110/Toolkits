...
export class ApiRepository {
  constructor() {this.state=createWorkspaceState();this.user=null;this.csrf='';this.persistent=false;this.generation=0;}
  ...
  clear(reason='logout') {const previous=this.user;this.generation++;this.user=null;this.csrf='';this.persistent=false;this.state=createWorkspaceState();this.onLost?.(reason,previous);}
